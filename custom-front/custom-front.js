...
jQuery(document).ready(function() {
	...
	if ( jQuery('article').hasClass('category-busquedas-laborales') ) {
		...
		if ( jQuery('article').hasClass('category-activa') ) {
			jQuery('<div class="buttons"><div><em>Podés postularte directamente enviándonos tu CV o referir a un amigo/a. En caso de que el perfil aplique para la búsqueda, nos pondremos en contacto.</em></div><a href="/categoria/busquedas-laborales/activa/">Ver otras búsquedas activas</a></div><a href="mailto:'+mails_rrhh+'?subject='+post_title+'" target="_blank" class="sc-button">Enviar / Referir CV</a></div>').insertAfter('#post-content table');
		}
		else {

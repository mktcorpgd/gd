...
function copyPostContent() {
	...
	jQuery('.wpcf7 input[name=CATSCASO]').val('2370,'+jQuery('.wpcf7-select[name*=UN] option:selected').attr('data-cat-id')+','+jQuery('.wpcf7-select[name*=UAC] option:selected').attr('data-cat-id'));

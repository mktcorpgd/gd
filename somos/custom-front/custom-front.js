...
$(document).on('click','.wpcf7-submit',function(e) {
	...
	$('.wpcf7-form').addClass('sending');
	$('.wpcf7-form.sending .wpcf7-submit').attr('name',$('.wpcf7-form.sending .wpcf7-submit').val());
	$('.wpcf7-form.sending .wpcf7-submit').val('Enviando...');
});


// FORMULARIOS - Al enviar un form
document.addEventListener('wpcf7submit', function(event) {
	$('.wpcf7-submit.sending').val($('.wpcf7-form.sending .wpcf7-submit').attr('name')).removeClass('sending').removeAttr('readonly');

...
jQuery(document).ready(function() {
	...
	if ( jQuery('.kit').length ) {
		...
		if ( unit_class.indexOf('uas') > -1 ) {
			jQuery('.kit .menu-item.propuestas-comerciales,.kit .folletos-digitales>.menu-item:not(:contains("Grupo Datco")),.kit .presentaciones-institucionales>.menu-item:not(:contains("Grupo Datco")),.kit .ppts>.menu-item:not(:contains("Grupo Datco"))').hide();

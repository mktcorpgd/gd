...
jQuery(document).ready(function() {
	...
	if ( jQuery('.address_maps').length ) {
		...
		addressAutocomplete1.addListener('place_changed', function() {
			...
			var img_src = 'https://maps.googleapis.com/maps/api/staticmap?size=300x300&maptype=roadmap&markers=size:mid%7Ccolor:red%7C'+address+'&zoom=17&key=AIzaSyBgKiaX5D3Pp4Jx16S_JBH4_vUJngmX3PM';

jQuery(document).ready(function(){
	...
	jQuery('body.profile-php.no-customize-support input[name=gdCUIL_mc],body.profile-php.no-customize-support input[name=gdPHONE_mc], input[name=gdUNIT_mc], input[name=gdANNIV_mc], input[name=], input[name=ocp_job_title], select[name=gdGroupfe587259d3]').attr('disabled','disabled');
